...
angular.module('softvApp')
  .controller('DetalleDesgloseCtrl', function (desgloseFactory,generalesSistemaFactory, $state,$stateParams, $filter, $rootScope, globalService, ngNotify, $localStorage) {
