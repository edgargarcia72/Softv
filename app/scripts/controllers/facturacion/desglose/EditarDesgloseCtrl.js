...
angular.module('softvApp')
  .controller('EditarDesgloseCtrl', function (desgloseFactory,generalesSistemaFactory, PermPermissionStore, $state, $stateParams, $filter, $rootScope, globalService, ngNotify, $localStorage) {
